...
const CadastrarDicaCulinaria = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert('Dica de culinária cadastrada com sucesso!');
            navigate('/culinaria-gastronomia'); // Redireciona para a página principal de culinária
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <input 
                        ...
                        placeholder="Ex: Técnicas, Conservação de alimentos"
                        required 
                    />
                </div>
