...
const EditarDicaTI = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const dadosAtualizados = {
            titulo,
            conteudo,
            tema: 'TI', // <-- Tema fixo para esta página
        ...
        try {
            ...
            alert('Dica de TI atualizada com sucesso!');
            navigate('/ti/editar'); // <-- Volta para a nova lista de edição
